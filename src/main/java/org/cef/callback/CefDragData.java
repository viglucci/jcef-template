...
public abstract class CefDragData {
  ...
  /**
   * Returns true if the drag data is a text or app.html fragment.
   */
  ...
  /**
   * Return the text/app.html fragment that is being dragged.
   */
  ...
  /**
   * Set the text/app.html fragment that is being dragged.
   * @param html The app.html fragment to be set.
   */
